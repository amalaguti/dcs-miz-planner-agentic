...
| `models.py` | The public contract: `MissionSpec` + enums. Free flight, intercept, CAP; reserves `triggers` | `pydantic` |
...
| `examples/` | Checked-in Mission Specs; free-flight, intercept, and CAP Manston examples |
