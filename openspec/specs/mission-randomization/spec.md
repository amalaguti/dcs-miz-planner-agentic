...
Seeded Spec→Spec variation for replayability. The compiler stays deterministic on
concrete Specs; randomization is a separate transform argument (seed + axes).
