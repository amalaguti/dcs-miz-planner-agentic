    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "free_flight, CAP, intercept, escort, or ground_attack uses Mount Pleasant "
                "(150° / 40 km South Atlantic; GA 269° / 21 km inland short of Goose Green). "
                "Falklands recon "
                "is unsupported. Call before "
                "emitting Spec JSON."
            ),
            "parameters": {
                "type": "object",
