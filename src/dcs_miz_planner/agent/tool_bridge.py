    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "use Incirlik; Nevada free_flight, CAP, intercept, escort, or ground_attack "
                "uses Nellis (CAP/intercept/escort 350° / 40 km desert north-range; "
                "GA 303° / 85 km inland past Creech); Falklands "
                "free_flight uses Mount Pleasant. "
                "Nevada recon and Falklands combat "
